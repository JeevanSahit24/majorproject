      ...
      <>
        ...
        <Grid container
          ...
          {userTechCount === 0 && <AddTechCard newTechnologyUrl={newTechnologyUrl} handleClickOpen={handleClickOpen}
            ...
            description={"Your technology stack is currently empty, add new tech to your technology to start building a picture of your threat model."}
            buttonLabel={"Add Technology"}
          />}
